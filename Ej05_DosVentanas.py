...
# programacion 3°B  
# dos ventanas que muestran nombre y apellido 
...
def abrir_ventana_nombre():
    ...
    etiqueta_nombre = tk.Label(ventana_nombre, text="Nombre: Leilani ", font=("Arial", 12))
    etiqueta_nombre.pack(pady=5)
    etiqueta_apellidos = tk.Label(ventana_nombre, text="Apellidos: Avitia Casarrubias", font=("Arial", 12))
